...
public class TicketPDFService {
    ...
    public byte[] generateTicketPDF(Ticket ticket) throws DocumentException {
        ...
        addTableCell(detailsTable, "From:", ticket.getSeat().getBus().getRoute().getSourceBusStop().getName(), labelFont, valueFont);
        addTableCell(detailsTable, "Destination:", ticket.getSeat().getBus().getRoute().getDestinationBusStop().getName(), labelFont, valueFont);
        addTableCell(detailsTable, "Departure Date:", ticket.getSeat().getBus().getDepartureDateTime().toString(), labelFont, valueFont);
